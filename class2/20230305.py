...
# checkbtn2 = Checkbutton(root,text="轉機1次",variable = checkbtnVal1,onvalue="轉機1次",offvalue="",fg="pink",command=show)
# checkbtn2.grid(row=1,column=1,sticky=W)

# checkbtn3 = Checkbutton(root,text="轉機2次以上",variable = checkbtnVal1,onvalue="轉機2次以上",offvalue="",fg="pink",command=show)
