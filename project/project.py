...
def nitendo():
    ...
    #row=4
    nitendo_game1_price1 = Label(A1,font = ("Inter",10), text="NT.0,846", fg = "#000000",bg = "#ECE8E7")
    nitendo_game1_price1.grid(column=0,row=4 ,padx=5,sticky=W)

    nitendo_game2_price2 = Label(A1,font = ("Inter",10), text="NT.0,329", fg = "#000000",bg = "#ECE8E7")
    nitendo_game2_price2.grid(column=2,row=4 ,padx=5, sticky=W)

    nitendo_game3_price3 = Label(A1,font = ("Inter",10), text="NT.0,985", fg = "#000000",bg = "#ECE8E7")
    nitendo_game3_price3.grid(column=4,row=4 ,padx=5, sticky=W)

    nitendo_game4_price4 = Label(A1,font = ("Inter",10), text="NT.0,359", fg = "#000000",bg = "#ECE8E7")
...
def playstation():
    ...
    #row=4
    playstation_game1_price1 = Label(B2,font = ("Inter",10), text="NT.0,846", fg = "#000000",bg = "#ECE8E7")
    playstation_game1_price1.grid(column=0,row=4 ,padx=5,sticky=W)

    playstation_game2_price2 = Label(B2,font = ("Inter",10), text="NT.0,329", fg = "#000000",bg = "#ECE8E7")
    ...
    playstation_game4_price4 = Label(B2,font = ("Inter",10), text="NT.0,359", fg = "#000000",bg = "#ECE8E7")
